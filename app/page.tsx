  ...
  return <>
    <section className="hero">
      ...
      <div className="theme-demo" aria-label="Theme architecture">
        ...
        <div><span>Current mode</span><strong>{themes.find(item => item.id === theme)?.label}</strong></div><i>→</i>
