...
export default function AlertsPage() {
  ...
  return (
    <>
      <PageHeader eyebrow="COMPONENTS · ALERT" title="Alerts" description="Alerts come in seven types — Primary, Secondary, Error, Success, Warning, Information, and Default — and two layouts: Vertical and Horizontal." />
