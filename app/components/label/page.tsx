...
export default function LabelPage() {
  ...
  return (
    <>
      <PageHeader eyebrow="COMPONENTS · LABEL" title="Label" description="The field label and its companion hint text — the title above a field and the informational line below it, reused across Text Input, Dropdown, and any other labeled structure." />
