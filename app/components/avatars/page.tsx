...
export default function AvatarsPage() {
  ...
  return (
    <>
      <PageHeader eyebrow="COMPONENTS · AVATAR" title="Avatars" description="Avatars come in three forms, each with a purpose: Image Avatars, Text Avatars, and Placeholder Avatars." />
