...
export default function CardPage() {
  ...
  return (
    <>
      <PageHeader eyebrow="COMPONENTS · CARD" title="Card" description="A flexible container composed from a checkbox, title, and content area — description, pills, or an input — with an optional image and footer slots for arbitrary actions." />
