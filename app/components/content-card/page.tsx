...
export default function ContentCardPage() {
  return (
    <>
      <PageHeader eyebrow="COMPONENTS · CONTENT CARD" title="Content Card" description="A compact, single-row card pairing a bold label with a fixed-size media or icon slot — for list and media-row layouts." />
